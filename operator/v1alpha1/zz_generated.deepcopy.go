...
func (in *ImageContentSourcePolicySpec) DeepCopyInto(out *ImageContentSourcePolicySpec) {
	*out = *in
	...
	if in.RepositoryMirrors != nil {
		in, out := &in.RepositoryMirrors, &out.RepositoryMirrors
		*out = make([]RepositoryMirrors, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepositoryMirrors) DeepCopyInto(out *RepositoryMirrors) {
	*out = *in
	if in.Mirrors != nil {
		in, out := &in.Mirrors, &out.Mirrors
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RepositoryMirrors.
func (in *RepositoryMirrors) DeepCopy() *RepositoryMirrors {
	if in == nil {
		return nil
	}
	out := new(RepositoryMirrors)
	in.DeepCopyInto(out)
	return out
}
